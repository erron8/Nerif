...
try {
  await bot.api.setMyCommands([
    { command: "start", description: "Onboard or reopen Nerif" },
    { command: "menu", description: "Show the main menu" },
    { command: "log", description: "Log food manually" },
    ...
    { command: "history", description: "Show recent meals" },
    { command: "delete_last", description: "Undo the last meal" },
    { command: "weight", description: "Log today's weight" },
